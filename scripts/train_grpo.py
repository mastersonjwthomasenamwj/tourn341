...
def main():
    ...
    element_dropout = ElementWiseOptimizerDropoutCallback(dropout_prob=0.08)
    ...
    dynamic_accum = DynamicGradientAccumulationCallback(
        ...
        increase_threshold=0.35,
        decrease_threshold=0.12,
        adjustment_window=60,
        adjustment_cooldown=120,
        log_frequency=25,
    ...
    dropout_callback = CoordinatedDropoutCallback(
        trainer,
        initial_dropout=0.08,
        gap_threshold=0.12,
        max_dropout=0.4,
        min_dropout=0.02,
        dropout_step=0.04,
